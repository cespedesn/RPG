...
namespace Engine
{
    public static class World
    {
        ...
        //These are constants
        //Can never have their value changed
        ...
        //Static Constructor
        //Since this is a static class, you cant instantiate.
        ...
        static World()
        {
            //Four methods to populate the different lists. 
            PopulateItems();
            PopulateMonsters();
            PopulateQuests();
            PopulateLocations();
        ...
        {
            //Creating new Monster object and saving it to the monster name (rat,snake,giantSpider)
            ...
            //Added variables to the static Monsters list.
            Monsters.Add(rat);
            Monsters.Add(snake);
            Monsters.Add(giantSpider);
        }

        //Wrapper Methods to get values from the static lists.
